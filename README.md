Punching Marlin
===============
Firmware for [this project](https://hackaday.io/project/5023-automatic-print-ejector). This is based on the [OpenBeam branch of Marlin](https://github.com/OpenBeamUSA/Marlin). The changes should not be hard to patch into any other flavor of Marlin, though.
